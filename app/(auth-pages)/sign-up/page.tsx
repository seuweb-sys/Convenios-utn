...
import { ArrowRight, Mail, Lock, Shield, Loader2, UserPlus } from "lucide-react";
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Label htmlFor="terms" className="text-sm text-muted-foreground cursor-pointer">
              Acepto los <Link href="/terms" className="text-blue-500 hover:underline">términos y condiciones</Link>
            </Label>
          </div>
        </div>
